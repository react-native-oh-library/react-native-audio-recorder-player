...
var __generator = (this && this.__generator) || function (thisArg, body) {
    ...
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" &&
...
var RNAudioRecorderPlayer = TurboModuleRegistry ? require('./src/NativeAudioRecorderPlayerModule').default :
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!this._isRecording) {
                        ...
                        return [2 /*return*/,
                            RNAudioRecorderPlayer.startRecorder(uri !== null && uri !== void 0 ? uri : 'DEFAULT',
                                audioSets,
                                meteringEnabled !== null && meteringEnabled !== void 0 ? meteringEnabled : false)];
                    }
                    ...
                    if (!this._playerSubscription) {
                        if (Platform.OS === 'android') {
                            this._playerSubscription =
                                DeviceEventEmitter.addListener('rn-playback', this.playerCallback);
                        } else {
